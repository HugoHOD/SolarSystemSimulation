...
public class SolarViewer extends Application {
    ...
    private HBox setButtons() {
        ...
        Button btnSatTog = new Button("Satellite Toggle");
        // now add handler
        btnSatTog.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                satOn = !satOn;
            }
        ...
        return new HBox(btnAnimOn, btnAnimOff, btnSatTog);
    }
